...
This folder maps repository claims to concrete commands, artifacts, and workshop/demo materials.
...
- `OPERATIONAL_READINESS_CHECKLIST.md` — Day-2 readiness gate for operations
