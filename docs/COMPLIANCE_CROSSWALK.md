...
- [security/CVE_REMEDIATION_AND_RISK_ACCEPTANCE_POLICY.md](security/CVE_REMEDIATION_AND_RISK_ACCEPTANCE_POLICY.md)
- [security/CVE_REVIEW_LOG.md](security/CVE_REVIEW_LOG.md)
...
| SI-4, SI-7 | System monitoring and software integrity | Own enterprise monitoring and risk acceptance for unresolved vulnerabilities | Review ACP supply-chain findings, alerting outputs, exception records, and quarterly review history together | Provides security gate, supply-chain policy, CVE governance policy, known-limitation tracking, and deterministic validation | [KNOWN_LIMITATIONS.md](KNOWN_LIMITATIONS.md), [security/CVE_REMEDIATION_AND_RISK_ACCEPTANCE_POLICY.md](security/CVE_REMEDIATION_AND_RISK_ACCEPTANCE_POLICY.md), [security/CVE_REVIEW_LOG.md](security/CVE_REVIEW_LOG.md), [SECURITY_GOVERNANCE.md](SECURITY_GOVERNANCE.md), `make security-gate` | Current open CVEs are disclosed and governed, not hidden or fully eliminated |
