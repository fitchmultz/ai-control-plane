...
complete -c acpctl -n '__fish_use_subcommand' -a 'tenant' -d 'Inspect and validate the design-only multi-tenant package'
complete -c acpctl -n '__fish_use_subcommand' -a 'evidence' -d 'Vendor evidence ingest workflows'
complete -c acpctl -n '__fish_use_subcommand' -a 'policy' -d 'ACP-native custom policy evaluation workflows'
...
complete -c acpctl -n '__fish_seen_subcommand_from tenant' -a 'inspect' -d 'Print a concise summary of the tracked tenant design package'
complete -c acpctl -n '__fish_seen_subcommand_from tenant' -a 'validate' -d 'Validate the tracked tenant design package and truth markers'
complete -c acpctl -n '__fish_seen_subcommand_from evidence' -a 'ingest' -d 'Normalize supported vendor evidence into ACP schema artifacts'
complete -c acpctl -n '__fish_seen_subcommand_from policy' -a 'eval' -d 'Evaluate local request/response records against custom ACP guardrails'
...
complete -c acpctl -n '__fish_seen_subcommand_from validate' -a 'policy-rules' -d 'Validate the tracked ACP custom policy rule contract'
complete -c acpctl -n '__fish_seen_subcommand_from validate' -a 'tenant' -d 'Validate the tracked tenant design package and truth markers'
...
complete -c acpctl -n '__fish_seen_subcommand_from db' -a 'off-host-drill' -d 'Validate a staged off-host backup copy and emit staged-local or separate-host recovery evidence'
