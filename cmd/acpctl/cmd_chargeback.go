...
func chargebackCommandSpec() *commandSpec {
	return &commandSpec{
		...
		Examples: []string{
			...
			"acpctl chargeback report --organization falcon-insurance --workspace claims-adjuster",
		...
		Children: []*commandSpec{
			newNativeCommandSpec(nativeCommandConfig{
				...
				Examples: []string{
					...
					"acpctl chargeback report --organization falcon-insurance --workspace claims-adjuster --month 2026-02",
				},
				Options: []commandOptionSpec{
					...
					{Name: "organization", ValueName: "ORG", Summary: "Tenant organization id for scoped reporting", Type: optionValueString},
					{Name: "workspace", ValueName: "WORKSPACE", Summary: "Tenant workspace id for workspace-scoped reporting", Type: optionValueString},
					{Name: "tenant-file", ValueName: "PATH", Summary: "Tenant design file to use for scoped reporting", Type: optionValueString, DefaultText: "demo/config/tenant_design.yaml"},
				...
				Bind: bindRepoParsed(bindChargebackReportOptions),
				...
				Sections: []commandHelpSection{
					{
						...
						Lines: []string{
							...
							"CHARGEBACK_SCOPE_KIND",
							"CHARGEBACK_SCOPE_LABEL",
							"CHARGEBACK_SCOPE_AGGREGATION",
							"CHARGEBACK_SCOPE_ORGANIZATION_ID",
							"CHARGEBACK_SCOPE_WORKSPACE_ID",
