...
func writeValidConfigContractRepo(t *testing.T, repoRoot string) {
	...
	writeFixtureFile(t, filepath.Join(repoRoot, "docs", "contracts", "config", "tenant_design.schema.json"), `{"type":"object"}`)
