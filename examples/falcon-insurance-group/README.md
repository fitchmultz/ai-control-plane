# Falcon Insurance Group Example Artifact Set

This example provides a sanitized customer-shaped artifact set for pilot closeout workflows and default Make variables.
