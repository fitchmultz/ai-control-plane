...
help-test:
	...
	@echo '  $(COLOR_GREEN)coverage-critical$(COLOR_RESET)  Enforce minimum coverage for critical internal Go packages'
	@echo '  $(COLOR_GREEN)coverage-report$(COLOR_RESET)    Print detailed coverage report for critical internal Go packages'
...
help-ci:
	...
	@echo '  $(COLOR_GREEN)coverage-critical$(COLOR_RESET)  Critical-package coverage gate enforced by ci-pr and ci-fast'
